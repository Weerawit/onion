...
@Controller
@RequestMapping("/report/saleOrderPaymentSummaryReport*")
public class SaleOrderPaymentSummaryReportController extends BaseFormController {
	
	private static final String[] DATE_PATTERN = new String[] {"dd/MM/yyyy HH:mm:ss", "dd/MM/yyyy"};

	private SaleOrderPaymentSummaryReportManager saleOrderPaymentSummaryReportManager;
	
	private LookupManager lookupManager;
	
	public SaleOrderPaymentSummaryReportManager getSaleOrderPaymentSummaryReportManager() {
		return saleOrderPaymentSummaryReportManager;
	}

	@Autowired
	public void setSaleOrderPaymentSummaryReportManager(SaleOrderPaymentSummaryReportManager saleOrderPaymentSummaryReportManager) {
		this.saleOrderPaymentSummaryReportManager = saleOrderPaymentSummaryReportManager;
	}
	...
	public ModelAndView list(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			return new ModelAndView("report/saleOrderPaymentSummaryReport", model.asMap());
		}
		try {
		...
		log.info(request.getRemoteUser() + " is quering saleOrderPaymentSummaryReport criteria := " + criteria);

		
		model.addAttribute("resultSize", saleOrderPaymentSummaryReportManager.querySize(criteria));
		model.addAttribute("saleOrderPaymentSummaryReportList", saleOrderPaymentSummaryReportManager.query(criteria, page, size, sortColumn, order));
		return new ModelAndView("report/saleOrderPaymentSummaryReport", model.asMap());
	}
}
