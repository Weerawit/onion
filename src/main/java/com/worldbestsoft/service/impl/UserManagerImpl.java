 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "com.worldbestsoft.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
	...
	public Integer querySize(User criteria) {
		return userDao.querySize(criteria);
	}

	@Override
	public List<User> query(User criteria, int page, int pageSize, String sortColumn, String order) {
		return userDao.query(criteria, page, pageSize, sortColumn, order);
	}
