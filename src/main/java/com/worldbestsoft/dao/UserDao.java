...
public interface UserDao extends GenericDao<User, Long> {
	...
	public abstract Integer querySize(User criteria);

	public abstract List<User> query(User criteria, final int page, final int pageSize, final String sortColumn, final String order);
