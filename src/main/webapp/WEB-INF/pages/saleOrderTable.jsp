				...
				<div class="media">
					...
					<div class="media-body">
						<h4 class="media-heading">
							<input type="hidden" name="catalog.code" value="<c:out value='${saleOrderItem.catalog.code }'/>" /> <input type="text" name="catalog.name" value="<c:out value='${saleOrderItem.catalog.name }'/>" class="input-large" autocomplete="off" />
						</h4>
					</div>
				</div>
			</display:column>
		...
		<display:table name="saleOrderItemList" cellspacing="0" cellpadding="0" excludedParams="*" requestURI="" id="saleOrderItem" class="table table-condensed table-striped table-hover table-bordered" export="false" pagesize="10" partialList="false">
			<display:column titleKey="saleOrderItem.catalog.code" sortable="true" sortProperty="catalog.code" class="span5">
				<div class="media">
					...
					<div class="media-body">
						<h4 class="media-heading">
							<span class="input-large uneditable-input"><c:out value="${saleOrderItem.catalog.name}" /></span>
						</h4>
					</div>
				</div>
			</display:column>
